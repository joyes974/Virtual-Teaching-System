...
<form action="<?=site_url("add_department/a/".$postable_id);?>" method="post">
...
Name: <input name="name" type="text" value="<?= (isset($name))?$name:'';?>"/> <br><br>
Status:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<select name="status">
<option value="<?= (isset($status))?$status:'';?>"><?= (isset($status))?$status:'';?></option>
