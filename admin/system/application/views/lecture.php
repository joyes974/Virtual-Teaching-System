...
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
                ...
                <div id="main-content"> <!-- Main Content Section with everything -->
                     ...
                     <form action="<?=site_url("lecture/search/");?>" method="post" style="float:right;">
                        Lecture Title :
                                ...
                                <div class="content-box-content">
                                        ...
                                        <div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
                                                ...
                                                <table>
                                                        ...
                                                        <thead>
                                                                <tr>
                                                                <th colspan=8>Teacher Information</th>
                                                                </tr>
                                                                <tr>
                                                                   <th>Id</th>
                                                                   <th>Email</th>
        ...
        <?php
                ...
                {
                        $status=$row->status;
                        $ac=anchor('lecture/mithun/'.$row->lecture_id.'/'.$row->status,'Deactive');
                        $dac=anchor('lecture/mithun/'.$row->lecture_id.'/'.$row->status,'Active');
                        echo "<tr>";
                        echo "<th>".$row->lecture_id."</th>";
                        echo "<th>".$row->teacher_email."</th>";
                        echo "<th>".$row->course_title ."</th>";
                        echo "<th>".$row->lecture_title ."</th>";
                        echo "<th><a href='".$ur."uploads/".$row->lecture."'>".$row->lecture."</a></th>";
                        if($status=='active')
                        {
                                echo "<td>".$ac."</td>";
                        }
                      ...
                      echo "<th>".anchor('lecture/delete/'.$row->lecture_id,'delete')."</th>";
                 }?>
