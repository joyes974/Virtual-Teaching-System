...
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <tr>
                <?php
                        ...
                        {
                                $status=$row->status;
                                $ac=anchor('user/mithun/'.$row->user_id.'/'.$row->status,'Deactive');
                                $dac=anchor('user/mithun/'.$row->user_id.'/'.$row->status,'Active');
                                echo "<tr>";
                                ...
                                echo "<td>".anchor('user/delete/'.$row->user_id,'delete')."</td>";
                                echo "</tr>";
                        }
                                                                ?>
