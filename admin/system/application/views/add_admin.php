        ...
        <body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
                ...
                <div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
                        ...
                        <ul id="main-nav">  <!-- Accordion Menu -->
                                ...
                                <li>
                                        <a href="<?=site_url();?>admin" class="nav-top-item no-submenu"> <!-- Add the class "no-submenu" to menu items with no sub menu -->
                                                Dashboard
                                        </a>
                                </li>
...
<table>  <br>
        ...
        <tr>
<?php $postable_id=(isset($post_id))?$post_id:'';?>
<form action="<?=site_url("add_admin/a/".$postable_id);?>" method="post">
Admin Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input name="admin_name" type="text" value="<?= (isset($name))?$name:'';?>" /><br><br>
Admin Password: &nbsp<input name="admin_passwrod" type="password" value="<?= (isset($password))?$password:'';?>" /><br><br>
Admin Email:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input name="admin_email" type="text" value="<?= (isset($email))?$email:'';?>" /><br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
