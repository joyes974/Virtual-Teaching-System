...
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
                ...
                <div id="main-content"> <!-- Main Content Section with everything -->
                        ...
                        <form action="<?=site_url("teacher/search/");?>" method="post" style="float:right;">
                        Name/Interest Subject :
        ...
        <tr>
                ...
                foreach($query as $row)  {
                        $status=$row->status;
                        $ac=anchor('teacher/mithun/'.$row->teacher_id.'/'.$row->status,'Deactive');
                        $dac=anchor('teacher/mithun/'.$row->teacher_id.'/'.$row->status,'Active');
                        echo "<tr>";
        ...
        echo  "<td>".$dac."</td>";
         ...
         echo "<th>".anchor('teacher/delete/'.$row->teacher_id,'delete')."</th>";
        }?>
