...
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
                ...
                <div id="main-content"> <!-- Main Content Section with everything -->
                        ...
                        <form action="<?=site_url("question/search/");?>" method="post" style="float:right;">
                        Question :
                                ...
                                <div class="content-box-content">
                                        ...
                                        <div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
                                                ...
                                                <table>
                                                          ...
                                                          <thead>
                                                                <tr>
                                                                <th colspan=8>User Question Information</th>
                                                                </tr>
                                                                <tr>
                                                                   <th>Id</th>
                                                                   <th>Lecture Id</th>
        ...
        <?php
                ...
                {
                        $status=$row->status;
                        $ac=anchor('question/mithun/'.$row->question_id.'/'.$row->status,'Deactive');
                        $dac=anchor('question/mithun/'.$row->question_id.'/'.$row->status,'Active');
                        echo "<tr>";
                        echo "<th>".$row->question_id."</th>";
                      ...
                      echo "<th>".anchor('question/delete/'.$row->question_id,'delete')."</th>";
                 }?>
