...
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
                ...
                <div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
                        ...
                        <ul id="main-nav">  <!-- Accordion Menu -->
                                ...
                                <li>
                                        <a href="<?=site_url();?>" class="nav-top-item no-submenu"> <!-- the class "no-submenu" to menu items with no sub menu -->
                                                Dashboard
                                        </a>
                                </li>
                ...
                <div id="main-content"> <!-- Main Content Section with everything -->
                        ...
                        <!-- Page Head -->
                        <h2>
                You are logged in <?php //echo $username; ?></h2>
                                ...
                                <div class="content-box-content">
                                        ...
                                        <div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
                                                ...
                                                <table>
                                                        ...
                                                        <thead>
                                                                <tr>
                                                                    <th colspan=5><a href="<?=site_url('add_department')?>" title="Add_Department">ADD</a></th>
                                                                </tr>
                                                                <tr>
                                                                    <th colspan=5>Department Information</th>
                                                                </tr>
                                                                <tr>
                                                                   <th>Department Id</th>
                                                                   <th>Parent Id</th>
        ...
        <tr>
         ...
         <?php
                ...
                $status=$row->status;
                $ac=anchor('department/mithun/'.$row->department_id.'/'.$row->status,'Deactive');
                $dac=anchor('department/mithun/'.$row->department_id.'/'.$row->status,'Active');
                echo "<tr>";
                echo "<th>".$row->department_id."</th>";
                ...
                echo "<th>".anchor('add_department/edit/'.$row->department_id.'/'.$row->parent_id.'/'.$row->name.'/'.$row->status,'edit')."</th>";
                echo "<th>".anchor('add_department/delete/'.$row->department_id,'delete')."</th>";
                echo "</tr>";
         }
