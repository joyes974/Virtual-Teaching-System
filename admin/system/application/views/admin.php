                                ...
                                <div class="content-box-content">
                                        ...
                                        <div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
                                                ...
                                                <table>
                                                       ...
                                                       <thead>
                                                                <tr>
                                                                    <th colspan=5><a href="<?=site_url('add_admin')?>" title="Add_Admin">ADD</a></th>
                                                                </tr>
                                                                <tr>
                                                                    <th colspan=5>Admin Information</th>
                                                                </tr>
                                                                <tr>
                                                                   <th>Admin Id</th>
                                                                   <th>Admin Name</th>
        ...
        <tr>
                <?php
                        foreach($query as $row)  {
                            ...
                            echo "<th>".anchor('add_admin/edit/'.$row->admin_id,'edit')."</th>";
                            echo "<th>".anchor('add_admin/delete/'.$row->admin_id,'delete')."</th>";
